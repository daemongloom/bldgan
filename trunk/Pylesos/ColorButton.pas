...
procedure TColorButton.Set3DFrame(Value: boolean);
begin
...
procedure TColorButton.CalcuateTextPosition(const Caption: string; var TRC: TRect;
  BiDiFlags: Integer);
var
  TB: TRect;
  TS, TP: TPoint;
...
procedure TColorButton.DrawButtonText(const Caption: string; TRC: TRect; State:
...
procedure Register;
begin
  RegisterComponents('Controls', [TColorButton]);
end;
